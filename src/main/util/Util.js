...
Util = new function() {
    ...
    this.arrayFillFunc = function(arr, func, length) {
        var len = length || arr.length;
        for (var i = 0; i < len; i++) arr[i] = func(i);
        return arr;
    };
    ...
    this.arrayAddAll = function(arr, elements) {
    ...
    this.arrayRemoveAllOccurrences = function(arr, element) {
        var i;
